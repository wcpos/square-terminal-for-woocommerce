...
final class ScopedDependencyTest extends TestCase {
 ...
 public function test_scoper_prefix(): void { self::assertStringContainsString("'prefix' => 'WCPOS\\\\WooCommercePOS\\\\SquareTerminal\\\\Vendor'", file_get_contents(dirname(__DIR__,2).'/scoper.inc.php')); }
 public function test_bootstrap_prefers_scoped_vendor(): void { $plugin=file_get_contents(dirname(__DIR__,2).'/square-terminal-for-woocommerce.php'); self::assertLessThan(strpos($plugin,'vendor/autoload.php'), strpos($plugin,'vendor_scoped/autoload.php')); }
}

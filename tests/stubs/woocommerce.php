...
class SQTWC_Test_Order {
	public array $meta = array(); public array $notes = array(); public bool $paid = false; public int $id; public string $key = 'key'; public string $transaction_id = '';
	...
	public function save(){} public function set_transaction_id($id){$this->transaction_id=$id;} public function payment_complete($id=''){ $this->paid=true; if($id){$this->transaction_id=$id;} }
	public function get_currency(){return 'USD';} public function get_total(){return '12.34';}
}

...
class SQTWC_Test_Order {
	public array $meta = array(); public array $notes = array(); public bool $paid = false; public int $id; public string $key = 'key'; public string $transaction_id = ''; public int $payment_complete_calls = 0; public string $total = '12.34'; public string $currency = 'USD';
